...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "Informasi seputar manajemen & BOD Sinergi Mandiri Perkasa ",
    openGraph: {
      title: " Sinergi Mandiri Perkasa | Manajemen Perusahaan",
      description: "Informasi seputar manajemen & BOD Sinergi Mandiri Perkasa ",
                  ...
                  <div className="md:col-span-2 flex flex-col justify-center space-y-4">
                    ...
                    <div className="text-center md:text-left">
                      ...
                      <div className="flex items-center gap-1.5 mt-2 justify-center md:justify-start">
                        <p className="text-smp-muted font-medium text-sm sm:text-base">
                          {position}
                        </p>
                      </div>
                    </div>
