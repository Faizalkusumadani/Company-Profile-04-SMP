...
export default function Formcontact() {
  ...
  const GOOGLE_SCRIPT_URL =
    "https://script.google.com/macros/s/AKfycbyFUYWH-qSOfB9BEFw61l0t5vd7RVfsxdfEZ_446T6gLs8amzuBRH3ocNBFe0eqSPSP-g/exec";
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            {errors.name && (
              <p className="mt-1 text-xs text-smp-red">{errors.name.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.email && (
              <p className="mt-1 text-xs text-smp-red">
        ...
        {/* Pesan */}
        <div>
          <label className="block text-sm text-smp-muted pb-2 mb-2">
        ...
        <div className="flex justify-end">
          <button
            ...
            className="flex items-center gap-2 rounded-full bg-smp-blue px-8 py-3 text-base font-medium text-white transition hover:bg-blue-400 disabled:opacity-50"
          >
            {isSubmitting ? (
              <>
      ...
      {showSuccessDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-lg">
            <div className="flex justify-center mb-4">
              <div className="rounded-full bg-green-100 p-3">
                <svg
                  ...
                  stroke="currentColor"
                  strokeWidth={2}
                  className="h-12 w-12 text-smp-red"
                >
                  <path
                    strokeLinecap="round"
            ...
            <p className="text-center text-base text-smp-muted pt-2">
