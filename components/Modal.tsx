  ...
  return (
    <>
      ...
      <button
        ...
        className="group inline-flex items-center gap-2 text-sm sm:text-base font-semibold text-smp-blue hover:gap-3 transition-all duration-200"
      >
        {t("bod.cta")}
          ...
          >
            ...
            >
              ...
              <button
                type="button"
                onClick={() => setIsOpen(false)}
                className="absolute top-4 right-4 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-smp-muted shadow-md hover:bg-gray-100 hover:text-smp-blue transition-colors"
                aria-label="Tutup"
              >
                <FaXmark size={20} />
              </button>
              ...
              <div className="flex shrink-0 flex-col items-center bg-gray-200 p-6 md:w-[34%] md:p-10 lg:w-[32%] border-b border-gray-200 md:border-b-0 md:border-r">
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="mt-2 flex items-center justify-center gap-1.5 md:justify-center">
                    ...
                    <p className="text-sm font-semibold text-smp-blue sm:text-base">
                      {position}
                    </p>
                  </div>
                </div>
              ...
              <div className="min-h-0 flex-1 overflow-y-auto p-6 md:p-10">
                <div className="space-y-4 text-sm leading-relaxed text-smp-muted sm:text-base">
